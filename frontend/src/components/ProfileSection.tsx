...
const ProfileSection = ({ profile, blogSize }: { profile: Profile, blogSize: number }) => {
    return (
        <>
            <Row className='justify-content-center align-items-center gx-0 mx-2 text-black mt-4 mt-md-0'>
                ...
                <Col xs={4} md={{ span: 2, order: 2 }} className='d-flex flex-column justify-content-center align-items-center mt-4 pe-3'>
